...
export const headerIntroData = {
  ...
  description: {
    de:"أنا ريان، مطور واجهة أمامية    أهدف الى تطوير مسيرتي المهنية والمشاركة في المشاريع الملهمة. أعرض هنا عملي وشغفي بتطوير الويب. دعونا نشكل الحلول الرقمية معًا ونشكل ",
     en: "I'm Rayan, a Front-End Web developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
